...
tokens = [ 'LET', 'BE', 'NAME', 'REPEAT', 'OR', 'NOT', 'CONCAT', 'DIGIT', 'CHAR', 'LETTER', 'WORD', 'CONST', 'NUMBER', 'BLANK', 'LOWCASE', 'UPCASE', 'PRINT', 'ONEMORE', 'ZEROMORE', 'TO', 'ONEOF', 'AND', 'END', 'BEGIN', 'HAS' ]
